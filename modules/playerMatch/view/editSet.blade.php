<?php
    $dataSet = $models['MatchSet']::find(request('data'));
    $datamodul = $models['PlayerMatch']::find($dataSet->player_match_id);
...
{{ Form::open(array('url' => '/api/PlayerMatch/editPlayerMatchData','class'=>'form form-horizontal
parsley-validated','id'=>'fEditPlayerMatchSet')) }}
<input type="hidden"
    name="PlayerMatchId"
    value="{!!$dataSet->id!!}">
<input type="hidden"
...
<div class="form-group row mb-1">
    <div class="col-md-12">
        ...
        {{ Form::text('game_set',$dataSet->set_of_match,['class'=>'form-control
...
<div class="form-group row mb-1">
    <div class="col-md-12">
        ...
        {{ Form::text('home_score',$dataSet->home_score,['class'=>'form-control
        parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'important!']) }}
    </div>
</div>
<div class="form-group row mb-1">
    <div class="col-md-12">
        ...
        {{ Form::text('away_score',$dataSet->away_score,['class'=>'form-control
        parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'important!']) }}
    </div>
</div>
<div class="form-group row mb-1">
...
<button class="btn btn-secondary d-none"
    id="re-take"
    type="button">Re-take Photo</button>

<button class="btn btn-danger"
    id="click-photo"
    type="button">Score Photo</button>
...
<script>
    ...
    // }
jQuery(function(){
	$("#fEditPlayerMatchSet").submit(function(event){
