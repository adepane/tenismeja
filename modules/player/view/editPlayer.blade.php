<?php
	$datamodul = $models['Player']::find(request('data'));
?>

{{ Form::open(['url' => '/api/player/editPlayerData','class'=>'form form-horizontal parsley-validated','id'=>'feditPlayer']) }}
{!! Form::hidden('playerId', $datamodul->id, []) !!}
...
<div class="form-group row mb-3">
	<div class="col-md-12">
		...
		{{ Form::text('l1_pts',$datamodul->l1_pts,['class'=>'form-control
...
<script>
jQuery(function(){
	$("#feditPlayer").submit(function(event){
