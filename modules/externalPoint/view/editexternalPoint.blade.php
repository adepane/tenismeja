<?php
	$datamodul = $models['ExternalPoint']::find(request('data'));
?>

{{ Form::open(['url' => '/api/externalPoint/editexternalPointdata','class'=>'form form-horizontal parsley-validated','id'=>'feditExternalPoint']) }}
{!! Form::hidden('externalPointId', $datamodul->id, []) !!}
...
<script>
jQuery(function(){
	$("#feditExternalPoint").submit(function(event){
