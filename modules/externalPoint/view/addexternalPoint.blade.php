{{ Form::open(array('url' => '/api/externalPoint/addexternalPointdata','class'=>'form form-horizontal parsley-validated','id'=>'fExternalPoint')) }}
...
<script>
jQuery(function(){
	$("#fExternalPoint").submit(function(event){
