<?php
	$datamodul = $models['Permission']::find(request('data'));
?>

{{ Form::open(['url' => '/api/permission/editpermissiondata','class'=>'form form-horizontal parsley-validated','id'=>'feditpermission']) }}
{!! Form::hidden('idPermission', $datamodul->id, []) !!}
...
<script>
jQuery(function(){
	$("#feditpermission").submit(function(event){
