<?php
	$datamodul = $models['$modulModels']::find(request('data'));
?>

{{ Form::open(['url' => '/api/$module/edit$moduledata','class'=>'form form-horizontal parsley-validated','id'=>'fedit$modulModels']) }}
{!! Form::hidden('$moduleId', $datamodul->id, []) !!}
...
<script>
jQuery(function(){
	$("#fedit$modulModels").submit(function(event){
